...
import { MapPin, Bell, Wifi, Leaf, CloudSun, RefreshCw, Droplets, Wind, Thermometer, Sun } from 'lucide-react-native';
...
<<<<<<< HEAD
                { borderColor: hailRisk ? Colors.red + '44' : stormRisk ? Colors.amber + '44' : Colors.border }
=======
                {
...
>>>>>>> fa1781c314271bc6225f3f556fc8cc84d76e834a
              ...
              <View style={styles.lwGrid}>
                {[
<<<<<<< HEAD
                  { icon: Thermometer, label: 'Temperature', value: `${weather.current.temperature}°C`, color: Colors.amber },
...
<<<<<<< HEAD
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.dailyForecastRow}>
...
<<<<<<< HEAD
                        <Text style={styles.dailyIcon}>{weatherIcon(dayDesc)}</Text>
=======
        ...
        <View style={styles.secondaryGrid}>
          {predictions.slice(1).map((pred, i) => (
            <MotiView
              ...
              animate={{ opacity: 1, translateY: 0 }}
<<<<<<< HEAD
              transition={{ type: 'timing', duration: 600, delay: 700 + i * 150 }}
=======
              transition={{
                type: "timing",
                duration: 600,
...
<<<<<<< HEAD
  ...
  dailyForecastRow: { flexDirection: 'row', gap: Spacing.md, paddingTop: Spacing.sm },
  dailyCell: { alignItems: 'center', gap: 3, minWidth: 44 },
  dailyDay: { fontSize: FontSize.xs, color: Colors.textMuted, fontWeight: '600' },
  dailyIcon: { fontSize: 18 },
  dailyMax: { fontSize: FontSize.sm, color: Colors.textPrimary, fontWeight: '700' },
  dailyMin: { fontSize: FontSize.xs, color: Colors.textMuted, fontWeight: '500' },
